...
for epoch in range(num_epochs):
    ...
    if epoch == num_epochs - 1:
        ...
        print('confusion matrix for training set = \n', conf_matrix)
        plt.savefig('Counter_Clipping_Confusion_Matrix_Training.png')
        plt.show()
        if i == len(X_train) - 1:
...
plt.savefig('Counter_Clipping_Plot_Input_Layer_Weights.png')
plt.show()
...
plt.savefig('Counter_Clipping_Plot_Counter_and_Output_Layer_Weights.png')
plt.show()
...
plt.legend(loc='lower center')
fig.subplots_adjust(bottom=0.5)
plt.savefig('Counter_Clipping_Plot_Input_Layer_Gradients.png')
plt.show()
...
plt.legend(loc='lower center')
fig.subplots_adjust(bottom=0.5)
plt.savefig('Counter_Clipping_Plot_Counter_and_Output_Layer_Gradients.png')
plt.show()
...
plt.legend(loc='lower center')
fig.subplots_adjust(bottom=0.5)
plt.savefig('Counter_Clipping_Plot_Accuracies_and_Losses.png')
plt.show()


df1.to_excel('Counter_Clipping.xlsx')
...
plt.savefig('Counter_Clipping_Vector_Field_Input_Layer_W11_W12.png')
plt.show()
...
plt.savefig('Counter_Clipping_Vector_Field_Input_Layer_W21_W22.png')
plt.show()
...
def test():
    ...
    bottom1, top1 = heat.get_ylim()
    heat.set_ylim(bottom1 + 0.5, top1 - 0.5)
    plt.savefig('Counter_Clipping_Confusion_Matrix_Testing.png')
    plt.show()
