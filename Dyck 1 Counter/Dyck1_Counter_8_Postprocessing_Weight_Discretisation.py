...
document_name = 'Dyck1_Counter_8_postprocessing_weight_discretisation_correct_weights_with_noise_5_Clipping_MSE_SGD_run_1.txt'
excel_name = 'Dyck1_Counter_8_postprocessing_weight_discretisation_correct_weights_with_noise_5_Clipping_MSE_SGD_run_1.xlsx'
...
def train():
    ...
    with open(document_name, 'a') as f:
        f.write('//////////////////////////////////////////////////\n')
        f.write('Updated parameters after rounding\n')
