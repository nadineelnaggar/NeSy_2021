...
document_name = 'Dyck1_Counter_7_L2_Regularisation_correct_weights_Sigmoid_BCE_SGD_run_3.txt'
excel_name = 'Dyck1_Counter_7_L2_regularisation_correct_weights_Sigmoid_BCE_SGD_run_3.xlsx'
    ...
    for epoch in range(num_epochs):
        ...
        for i in range(len(X_train)):
            ...
            for param in model.parameters():
                l1_regularisation += torch.norm(param, 2)
