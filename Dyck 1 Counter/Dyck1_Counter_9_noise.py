...
document_name = 'Dyck1_Counter_9_correct_weights_with_noise_Clipping_L1_SGD_run_3.txt'
excel_name = 'Dyck1_Counter_9_correct_weights_with_noise_Clipping_L1_SGD_run_3.xlsx'
...
def train():
    ...
    # df1.to_excel('Dyck1_Counter_9_Clipping_L1.xlsx')
