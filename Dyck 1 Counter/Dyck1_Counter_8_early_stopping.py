...
document_name = 'Dyck1_Counter_8_early_stopping_Clipping_MSE_SGD_run_1.txt'
excel_name = 'Dyck1_Counter_8_early_stopping_Clipping_MSE_SGD_run_1.xlsx'
...
def train():
    ...
    df1['early stopping']=early_stopping

    # df1.to_excel('Dyck1_Counter_8_early_stopping_Clipping_MSE.xlsx')
