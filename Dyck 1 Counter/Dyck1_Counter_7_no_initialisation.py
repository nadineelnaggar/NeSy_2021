...
document_name = 'Dyck1_Counter_7_no_initialisation_Sigmoid_BCE_run_3.txt'
excel_name = 'Dyck1_Counter_7_no_initialisation_Sigmoid_BCE_run_3.xlsx'
...
def train():
    ...
    # df1.to_excel('Dyck1_Counter_7_no_initialisation_Sigmoid_BCE.xlsx')
